...
function OperatorSilhouette() {
  return (
    <div className="relative flex flex-col items-center drop-shadow-[0_0_22px_rgba(59,130,246,0.45)]">
      <div className="h-36 w-[2px] bg-blue-500/95" />

      <img
        src={OPERATOR_SRC}
        alt="operatore su fune edil sky"
        className="w-24 md:w-28 object-contain drop-shadow-[0_0_30px_rgba(59,130,246,0.9)]"
      />
...
export default function EdilSkyLanding() {
  ...
  const operatorY = useTransform(scrollYProgress, [0, 1], ["-42vh", "145vh"]);
