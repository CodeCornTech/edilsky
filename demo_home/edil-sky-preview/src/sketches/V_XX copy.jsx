    ...
    return (
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
            <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-black via-zinc-950 to-zinc-900">
                ...
                <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center text-zinc-400 text-xs tracking-[0.35em] uppercase">Scroll per scendere</div>
            </section>
            {/* SERVIZI 1/2 + 1/2 VOID */}
            ...
            <section className="relative border-t border-white/10 bg-zinc-950 py-24">
                <div className="max-w-5xl mx-auto px-6 text-center">
                    ...
                    <h2 className="mt-4 text-4xl md:text-6xl font-black uppercase leading-[0.95]">
                        Più velocità .<span className="block text-blue-500">Meno struttura .</span>
                        <span className="block">Più controllo .</span>
                    </h2>
                    <p className="mt-6 max-w-2xl mx-auto text-zinc-400 text-lg leading-relaxed">Una landing pensata per sembrare più una presentazione cinematografica che un classico sito di edilizia .</p>
                    <div className="mt-10 flex flex-wrap justify-center gap-4">
                        <button className="rounded-2xl bg-blue-600 px-6 py-4 font-semibold hover:bg-blue-500 transition">Prenota sopralluogo</button>
                        <button className="rounded-2xl border border-white/15 bg-white/5 px-6 py-4 font-semibold hover:bg-white/10 transition">Vedi realizzazioni</button>
                    </div>
                </div>
            </section>
        </div>
