...
function useAutoSlide(total, delay = 2500) {
...
function MeshRibbon({ className = "", gradient = "from-orange-500 via-amber-400 to-orange-200", delay = 0 }) {
  return (
    <motion.div
...
function RibbonScene({ accent, glow }) {
  return (
...
function LeftPanel({ slide, activeIndex, setIndex }) {
  return (
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1600px] flex-col px-4 py-4 sm:px-6 lg:px-10">
        <header className="relative z-30 flex items-center justify-between rounded-[2rem] border border-white/40 bg-black/75 px-4 py-3 text-white shadow-2xl backdrop-blur-xl">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <button className="rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm text-white/85">
              Full view
            </button>
            <button className="rounded-full bg-sky-500 px-4 py-2 text-sm font-medium text-white shadow-lg shadow-sky-500/30">
