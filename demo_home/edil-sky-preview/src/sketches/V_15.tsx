...
export default function EdilSkyLanding() {
  ...
  return (
    <div
      ref={scrollRef}
      className="h-screen overflow-y-scroll snap-y snap-mandatory bg-black text-white overflow-x-hidden"
    >
      {/* OPENING VOID */}
      ...
      <section className="relative h-screen snap-start flex items-center justify-center bg-gradient-to-b from-black via-zinc-950 to-zinc-900">
        ...
        />
        <div
          className="absolute top-0 left-1/2 -translate-x-1/2 h-40 w-1 bg-[var(--edil-blue-light)]"
          style={{
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <div
              className="inline-flex items-center gap-3 rounded-full border px-4 py-2 text-sm tracking-[0.2em] uppercase text-[var(--edil-blue-light)]"
              style={{
            ...
            <h1 className="mt-6 text-5xl md:text-7xl font-black uppercase leading-[0.9] tracking-tight">
              Arriviamo
              <span className="block text-[var(--edil-blue-light)]">dove gli altri</span>
              <span className="block">si fermano</span>
            </h1>

            <p className="mt-6 max-w-xl text-zinc-300 text-lg md:text-xl leading-relaxed">
              Interventi verticali ad alto impatto visivo e operativo . Manutenzione , messa in
              sicurezza , ripristini e lavori in quota senza ponteggi .
            </p>

            <div className="mt-8 flex flex-wrap gap-4">
              <button className="rounded-2xl bg-[var(--edil-blue-main)] px-6 py-4 font-semibold transition hover:bg-[var(--edil-blue-dark)]">
                Richiedi sopralluogo
              </button>

              <button className="rounded-2xl border border-white/15 bg-white/5 px-6 py-4 font-semibold transition hover:bg-white/10">
                Guarda i servizi
              </button>
            </div>
          </div>
          ...
          <div className="relative h-[70vh] rounded-[2rem] border border-white/10 bg-zinc-950/70 backdrop-blur-sm overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between rounded-2xl border border-white/10 bg-black/50 px-5 py-4 text-sm uppercase tracking-[0.25em] text-zinc-300 backdrop-blur-md">
              ...
              <span className="text-[var(--edil-blue-light)]">GRANDI GABBIANI</span>
            </div>
          </div>
        </div>
